...
public class NavigationBarSettings extends SettingsPreferenceFragment implements
    ...
    private static final String PREF_NAVBAR_MENU_LOCATION = "pref_navbar_menu_location";
    ...
    private static final String NAVIGATION_BAR_SHOW_IME_ARROWS = "navigation_bar_show_ime_arrows";
    ...
    SwitchPreference mNavBarShowImeArrows;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mMenuDisplayLocation = (ListPreference) findPreference(PREF_NAVBAR_MENU_LOCATION);
        mMenuDisplayLocation.setValue(Settings.System.getInt(getActivity()
                .getContentResolver(), Settings.System.NAVIGATION_BAR_MENU_LOCATION,
                0) + "");
        ...
        mNavBarMenuDisplayValue = Settings.System.getInt(getActivity()
                .getContentResolver(), Settings.System.NAVIGATION_BAR_MENU_VISIBILITY,
                2);
        ...
        mNavBarShowImeArrows = (SwitchPreference) findPreference(NAVIGATION_BAR_SHOW_IME_ARROWS);
        mNavBarShowImeArrows.setChecked(Settings.System.getInt(getContentResolver(),
                Settings.System.NAVIGATION_BAR_SHOW_IME_ARROWS, 0) == 1);
        mNavBarShowImeArrows.setOnPreferenceChangeListener(this);
    ...
    private void updateNavbarPreferences(boolean show) {
        ...
        mNavBarShowImeArrows.setEnabled(show);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mMenuDisplayLocation) {
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.NAVIGATION_BAR_MENU_LOCATION, Integer.parseInt((String) newValue));
            return true;
        } else if (preference == mNavBarMenuDisplay) {
            mNavBarMenuDisplayValue = Integer.parseInt((String) newValue);
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.NAVIGATION_BAR_MENU_VISIBILITY, mNavBarMenuDisplayValue);
            ...
            return true;
        } else if (preference == mNavBarShowImeArrows) {
            Settings.System.putInt(getActivity().getContentResolver(),
