...
public class NavigationBarButtonStyle extends SettingsPreferenceFragment implements
        OnPreferenceChangeListener {

    private static final String TAG = "NavigationBarButtonStyle";
    ...
    private PreferenceScreen refreshSettings() {
        ...
        addPreferencesFromResource(R.xml.navigation_bar_button_style);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        menu.add(0, MENU_RESET, 0, R.string.reset)
                .setIcon(R.drawable.ic_action_reset) // use the reset settings icon
